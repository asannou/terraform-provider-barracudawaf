# barracudawaf_http_request_rewrite

`barracudawaf_http_request_rewrite` manages `HTTP Request Rewrite` on the Barracuda Web Application Firewall.

## Example Usage

```hcl
resource "barracudawaf_http_request_rewrite" "example" {
