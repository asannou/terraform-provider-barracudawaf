...
func resourceCudaWAFHTTPResponseRewrite() *schema.Resource {
	return &schema.Resource{
		Create: resourceCudaWAFHTTPResponseRewriteCreate,
		Read:   resourceCudaWAFHTTPResponseRewriteRead,
		Update: resourceCudaWAFHTTPResponseRewriteUpdate,
		Delete: resourceCudaWAFHTTPResponseRewriteDelete,
		...
		Description: "`barracudawaf_http_response_rewrite` manages `HTTP Response Rewrite` on the Barracuda Web Application Firewall.",
	}
}

func resourceCudaWAFHTTPResponseRewriteCreate(d *schema.ResourceData, m interface{}) error {
	...
	resourceEndpoint := "/services/" + serviceName + "/http-response-rewrite-rules"
	err := client.CreateBarracudaWAFResource(name, hydrateBarracudaWAFHTTPResponseRewriteResource(d, "post", resourceEndpoint))
	...
	d.SetId(name)
	return resourceCudaWAFHTTPResponseRewriteRead(d, m)
}

func resourceCudaWAFHTTPResponseRewriteRead(d *schema.ResourceData, m interface{}) error {
	client := m.(*BarracudaWAF)
...
func resourceCudaWAFHTTPResponseRewriteUpdate(d *schema.ResourceData, m interface{}) error {
	client := m.(*BarracudaWAF)
	...
	resourceEndpoint := "/services/" + serviceName + "/http-response-rewrite-rules"
	err := client.UpdateBarracudaWAFResource(name, hydrateBarracudaWAFHTTPResponseRewriteResource(d, "put", resourceEndpoint))
...
func resourceCudaWAFHTTPResponseRewriteDelete(d *schema.ResourceData, m interface{}) error {
	client := m.(*BarracudaWAF)
...
func hydrateBarracudaWAFHTTPResponseRewriteResource(d *schema.ResourceData, method string, endpoint string) *APIRequest {
